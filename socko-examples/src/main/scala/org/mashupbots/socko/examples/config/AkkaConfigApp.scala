...
/**
 * This example shows how load your web server configuration from AKKA's `application.conf`. It is found in the root
 * class path.  The source file is found in `src/main/resources`.
